...
void loop() {   
//--------------------------------------------------------------
  if(Firebase.getBool(firebaseData,"house_1/Bath/Luz_Princ")){
    lcd.clear();
    lcd.setCursor(0,0);
    lcd.print("    Conexion    ");
    lcd.setCursor(0,1);
    ...
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1 && firebaseData.boolData () == aux_fb && digitalRead(ACTUADOR_PARED) == digitalRead(ACTUADOR_LUZ_ON_OFF_PRINC)){
       Firebase.setBool(firebaseData,"house_1/Bath/Luz_Princ", false);
       aux_fb = 0; 
      }
       ...
       Firebase.setBool(firebaseData,"house_1/Bath/Luz_Princ", true);
       aux_fb = 1; 
      }
