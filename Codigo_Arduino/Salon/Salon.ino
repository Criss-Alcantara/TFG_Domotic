...
void loop() {  
  ...
  if (currentMillis - previousMillis >= 5000) { //envia la temperatura cada 5 segundos
    ...
    lcd.print(HUMEDAD);
    lcd.print("%"); 
    Firebase.setInt(firebaseData,"house_1/Salon/Temperatura",TEMPERATURA);
    Firebase.setInt(firebaseData,"house_1/Salon/Humedad",HUMEDAD);
    previousMillis = currentMillis;
  }
  
//--------------------------------------------------------------
  //ESTADO LUZ 
  if(Firebase.getBool(firebaseData,"house_1/Salon/Luz_Princ")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1 && firebaseData.boolData () == aux_fb && digitalRead(ACTUADOR_PARED) == digitalRead(ACTUADOR_LUZ_ON_OFF_PRINC)){
       Firebase.setBool(firebaseData,"house_1/Salon/Luz_Princ", false);
       aux_fb = 0; 
      }
       ...
       Firebase.setBool(firebaseData,"house_1/Salon/Luz_Princ", true);
       aux_fb = 1; 
      }
