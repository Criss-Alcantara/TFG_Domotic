...
void loop() {  
  ...
  if (currentMillis - previousMillis >= 5000) { //envia la temperatura cada 5 segundos
    ...
    lcd.print(HUMEDAD);
    lcd.print("%"); 
    Firebase.setInt(firebaseData,"house_1/Dormitorio/Hab_Princ/Temperatura",TEMPERATURA);
    Firebase.setInt(firebaseData,"house_1/Dormitorio/Hab_Princ/Humedad",HUMEDAD);
    previousMillis = currentMillis;
  }
  
//--------------------------------------------------------------
  Serial.println((String)digitalRead(ACTUADOR_PARED));
  if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Luz_Princ")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1 && firebaseData.boolData () == aux_fb && digitalRead(ACTUADOR_PARED) == digitalRead(ACTUADOR_LUZ_ON_OFF_PRINC)){
       Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Luz_Princ", false);
       aux_fb = 0; 
      }
       ...
       Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Luz_Princ", true);
       aux_fb = 1; 
      }
...
//--------------------------------------------------------------  
  //PERSIANA ABRIR
  if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Persiana_Abrir") ){
    if(firebaseData.dataType() == "boolean"){
...
//--------------------------------------------------------------
   //PERSIANA CLOSE
   if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Persiana_Cerrar")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1){
          servo1.write(180);
...
//--------------------------------------------------------------
   //PERSIANA PARAR
   if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Persiana_Parar")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1){
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Persiana_Parar", false);
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Persiana_Abrir", false);
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Princ/Persiana_Cerrar", false);
      }
     }
