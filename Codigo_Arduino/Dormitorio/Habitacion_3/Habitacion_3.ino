...
// LUZ PRINCIPAL 
int ACTUADOR_LUZ_ON_OFF_TERC = 0;
//PERSIANA
...
void setup() { 
  ...
  //LUZ ON - OFF
  pinMode (ACTUADOR_LUZ_ON_OFF_TERC, OUTPUT); // D3
  // ACTUADOR PARED
...
void loop() {  
  ...
  if (currentMillis - previousMillis >= 5000) { //envia la temperatura cada 5 segundos
    ...
    lcd.print(HUMEDAD);
    lcd.print("%"); 
    Firebase.setInt(firebaseData,"house_1/Dormitorio/Hab_Terc/Temperatura",TEMPERATURA);
    Firebase.setInt(firebaseData,"house_1/Dormitorio/Hab_Terc/Humedad",HUMEDAD);
    previousMillis = currentMillis;
  }
  
//--------------------------------------------------------------
  Serial.println("Rele: " + (String)digitalRead(ACTUADOR_LUZ_ON_OFF_TERC) + "  FC: " + digitalRead(ACTUADOR_PARED));
  if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Luz_Terc")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1 && firebaseData.boolData () == aux_fb && digitalRead(ACTUADOR_PARED) == digitalRead(ACTUADOR_LUZ_ON_OFF_TERC)){
       Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Luz_Terc", false);
       aux_fb = 0; 
      }
      else if(firebaseData.boolData () == 0 && firebaseData.boolData () == aux_fb && digitalRead(ACTUADOR_PARED) != digitalRead(ACTUADOR_LUZ_ON_OFF_TERC)){
       Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Luz_Terc", true);
       aux_fb = 1; 
      }
      else if(firebaseData.boolData () == 1 && firebaseData.boolData () != aux_fb && digitalRead(ACTUADOR_PARED) == digitalRead(ACTUADOR_LUZ_ON_OFF_TERC)){
...
//--------------------------------------------------------------  
  //PERSIANA ABRIR
  if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Abrir") ){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1){
          servo1.write(0);
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Abrir", false);
      }
     }
  }
  else {
...
//--------------------------------------------------------------
   //PERSIANA CLOSE
   if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Cerrar")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1){
          servo1.write(180);
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Cerrar", false);
      }
     }
  }
  else {
...
//--------------------------------------------------------------
   //PERSIANA PARAR
   if(Firebase.getBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Parar")){
    if(firebaseData.dataType() == "boolean"){
      if(firebaseData.boolData () == 1){
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Parar", false);
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Abrir", false);
          Firebase.setBool(firebaseData,"house_1/Dormitorio/Hab_Terc/Persiana_Cerrar", false);
      }
     }
